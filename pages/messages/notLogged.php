...
<html lang="pt-br">
  ...
  <body class="body-messages">
    ...
    <header class="header header-messages">
      <nav class="nav">
        <a href="#" class="nav__home-btn">
          <h1 class="nav__title">Braçada Final</h1>
        </a>
        <ul class="nav__list">
          <li
            class="nav__list-item nav__list-item--hover nav__list-item--focus"
          >
          ...
          <li
            class="nav__list-item nav__list-item--hover nav__list-item--focus"
          >
            <a href="../pages/atletas/athletes.html" class="nav__list-link"
              >Atletas</a
            >
          </li>
          <li
            class="nav__list-item nav__list-item--hover nav__list-item--focus"
          >
            <a href="../pages/medals/medalhas.html" class="nav__list-link"
              >Medalhas</a
            >
          </li>
          <li
          ...
          <li
            class="nav__list-item nav__list-item--hover nav__list-item--focus"
          >
            <a href="../homepage/index.html" class="nav__list-link">Quiz</a>
          </li>
        </ul>

        <div class="nav__container-buttons">
          <a
            href="../register & login/register.html"
    ...
    <main class="main main-messages">
        <section class="notlogged-message">
            <h2 class="notlogged-message__title">
                Ocorreu um erro ao acessar este conteúdo
            </h2>
            <p class="notlogged-message__title">
                Você precisa estar logado para acessar este conteúdo
            </p>

            <div class="buttons__container">
                <a href="../register & login/register.html" class="button notlogged__button notlogged__button--hover notlogged__button--hover">Cadastrar</a>
                <a href="../register & login/login.html" class="button notlogged__button notlogged__button--hover notlogged__button--focus">Logar</a>
            </div>
        </section>
    </main>
  </body>
