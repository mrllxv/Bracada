    ...
    <header class="header header-gallery">
        <nav class="header__nav">
            ...
            <ul class="nav__list">
                ...
                <li class="nav__list-item nav__list-item--hover nav__list-item--focus">
                    <a href="../atletas/athletes.html" class="nav__list-link">Atletas</a>
                </li>
                <li class="nav__list-item nav__list-item--hover nav__list-item--focus">
                    <a href="../medals/medalhas.html" class="nav__list-link">Medalhas</a>
                </li>
                <li class="nav__list-item nav__list-item--hover nav__list-item--focus">
    ...
    <main class="main">
        <section class="banner-gallery">
            <div class="banner-gallery__container">
                ...
                <p class="banner-gallery__description">Confira os momentos mais marcantes dos esportes olímpicos</p>
            </div>
